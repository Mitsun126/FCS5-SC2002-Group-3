...
public class HDB_Manager extends User {
	...
	public HDB_Manager(String name, String NRIC, int age, String marital_status) {
		super(name, NRIC, age, marital_status);
		this.createdProjects = new ArrayList<>();
	}
	
	public void createProject(String projectName, String neighbourhood, String t1, int nof1, int sp1, String t2, int nof2, int sp2, String aod, String acd, int noo) {
	...
	public ArrayList<Project> viewAllProjects(ArrayList<Project> allProjects){
		return allProjects;
	}
	...
	//Viewing all enquires in a project
		...
		public void approveOfficer(Project project, HDB_Officer officer) {
			...
			System.out.println("Officer " + officer.get_Name() + " approved for project " + project.get_ProjectName() + "!");
		}
